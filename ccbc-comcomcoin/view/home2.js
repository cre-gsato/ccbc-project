    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <View style={[{ flex: 0.3 }]}>
          ...
          <Text>2019.03.15 HARVESTに関するプレスリリースしました。</Text>
          <Text>2018.09.15 財界さっぽろ様の企業特集に掲載されました。</Text>
          <Text>2018.09.14 BHIPの理事に就任致しました。</Text>
        </View>
        <View
          style={[
            {
        ...
        <View style={[{ flex: 0.3, flexDirection: 'row' }]}>
          ...
          >
            <Image
              resizeMode="contain"
              source={require('./../images/icons8-ball-point-pen-48.png')}
            />
            <Text>記事投稿</Text>
          </View>
          <View
